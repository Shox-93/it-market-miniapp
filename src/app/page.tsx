...
const sampleItems: Record<SectionKey, { title: string; meta: string }[]> = {
  vacancies: [
    ...
    { title: "Mobile Developer", meta: "Flutter / React Native" },
  ],
  orders: [
    { title: "Разработать Telegram-бота", meta: "1200 $" },
    { title: "Создать интернет-магазин", meta: "3000 $" },
    { title: "Сделать CRM", meta: "1800 $" },
  ],
  companies: [
          ...
          <CardContent className="p-5">
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-4 flex items-center gap-3 rounded-2xl bg-[#091235] p-4">
